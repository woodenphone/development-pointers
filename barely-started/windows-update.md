...
Windows Update has a very annoying habit of deciding to reboot your machine unexpectedly, like when you go to the toilet for ten minutes.


* TODO: Explain why we deliberately break `MusNotification.exe` more clearly and in more detail.



- See file: </nonfree/windows/prevents-auto-restart-by-dummy-debugger.reg>


* TODO: Move these blocks into own files in /nonfree

'windows_update_notification_only_toggle.bat' from https://superuser.com/questions/1214503/disable-windows-10-update-notification-osd
```cmd
goto="init" /* %~nx0
...
from https://superuser.com/questions/1214503/disable-windows-10-update-notification-osd
```cmd
...
### Disabling windows update (links)
- https://superuser.com/questions/1214503/disable-windows-10-update-notification-osd
- https://superuser.com/questions/972038/how-to-get-rid-of-updates-are-available-message-in-windows-10
- https://community.spiceworks.com/t/updates-are-available/585018
- https://github.com/szepeviktor/windows-workstation
