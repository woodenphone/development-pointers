...
## Shell special vars:
# PATH= # TODO: copypaste in.
## Tracing
# set -o verbose ## Print shell input lines as they are read.
# set -o xtrace # Print a trace of simple commands. (Uses $PS4)
# PS4='+ ' # Default value.
# PS4='+ $LINENO: ' # Try printing line number in xtrace.
# PS4='+ ${BASH_SOURCE[-1]} ${FUNCNAME[-1]} ${BASH_LINENO[-1]} ' # Try printing 'file func line' in xtrace.
## ==========< /Shell setup >========== ##
